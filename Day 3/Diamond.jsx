  ...
  return (
    <div className="package">
        ...
        <div>
          ...
          <p>For 50 to 100 members, a memorable birthday</p>
          </center>
        </div>
        ...
        <form className="package-form" onSubmit={handleSubmit}>
            ...
            <Box>
              <label>Choose maximum of 5 events:</label>
              <br></br><br></br>
              <label>
              ...
              <label>
              <br></br>
                <input type="checkbox" name="Popcorn stall" checked={selectedCheckboxes.includes('Popcorn stall')} onChange={() => handleCheckboxChange('Popcorn stall')} />
                Popcorn stall
              </label>
              <label>
              <br></br>
                <input type="checkbox" name="Cotton-candy shop" checked={selectedCheckboxes.includes('Cotton-candy shop')} onChange={() => handleCheckboxChange('Cotton-candy shop')} />
                Cotton-candy shop
              </label>
            </Box>
            <Box >
